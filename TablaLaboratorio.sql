...
GO
PRINT N'La operación de refactorización Cambiar nombre con la clave  se ha omitido; no se cambiará el nombre del elemento [dbo].[Table].[Id] (SqlSimpleColumn) a IdLaboratorio';
...
CREATE TABLE [dbo].[Table] (
    ...
    PRIMARY KEY CLUSTERED ([IdLaboratorio] ASC)
);
